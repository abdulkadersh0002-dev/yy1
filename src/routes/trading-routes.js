...
import { attachLayeredAnalysisToSignal } from '../services/ea-signal-pipeline.js';
...
export default function tradingRoutes({
  ...
  router.post('/signal/generate', requireSignalsGenerate, async (req, res) => {
    ...
    const { pair, broker, eaOnly, analysisMode, broadcast: wantsBroadcast } = parseResult.data;
  ...
  router.post('/signal/batch', requireSignalsGenerate, async (req, res) => {
    try {
      ...
      const { pairs, broker, eaOnly, analysisMode } = parseResult.data;
  ...
  router.post('/trade/execute', requireTradeExecute, async (req, res) => {
    ...
    const { pair, broker } = parseResult.data;
